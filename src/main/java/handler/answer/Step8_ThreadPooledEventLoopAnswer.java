...
public class Step8_ThreadPooledEventLoopAnswer {
    ...
    private final Step6_ThreadPooledIncomingMessageAnswer incomingMessage = new Step6_ThreadPooledIncomingMessageAnswer(pool, pendingMessages, switchKeysToWriteActions);
