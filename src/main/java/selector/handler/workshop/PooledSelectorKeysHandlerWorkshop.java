 ...
 */
public class PooledSelectorKeysHandlerWorkshop {
    ...
    private final PooledReadHandlerWorkshop readHandler = new PooledReadHandlerWorkshop(pool, pendingData, selectorActions);
